...
@section('content')
    <section>
        <div class="container">
            <div class="row d-flex py-5">
                ...
                <div class="col-lg-6 text-center my-auto">
                    <img class="programmer-img p-5 wow bounceInUp" data-wow-duration="2s" src="{{asset('images/programmer.svg')}}" alt="css, html, js, php, react, vue, c#, .net">
                </div>
            ...
            <div class="container">
                <div class="row d-flex py-5">
                    ...
                    <div class="col-lg-6 text-right my-auto">
                        <img class="programmer-img p-5" data-wow-duration="2s" src="{{asset('images/help.svg')}}" alt="css, html, js, php, react, vue, c#, .net">
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row d-flex py-5">
                <div class="col-lg-6 text-right my-auto">
                    <img class="programmer-img p-5" data-wow-duration="2s" src="{{asset('images/other.svg')}}" alt="css, html, js, php, react, vue, c#, .net">
                </div>
                <div class="col-lg-6 text-left my-auto">
